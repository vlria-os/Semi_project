...
public class GuestBoardController {
    ...
    public String list(
        ...
        model.addAttribute("content", "guest/list");
        return "layout";
    }
...
//            }
    ...
    //1.수정 비밀번호 체크화면
    @GetMapping("/guest/edit/check/{id}")
    ...
    //3. 수정 처리
    @PostMapping("/guest/edit")//post요청 매핑 추가 필요
