...
public interface RequestMapper {
    ...
    //field용
    List<ApprovalConfDto> approvalConfIn(Map<String,Object> map);

    List<ApprovalConfDto> approvalConfOut(Map<String,Object> map);

    int approvalConfIn_count();
    int approvalConfOut_count();
